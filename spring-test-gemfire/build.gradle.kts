...
publishingDetails {
  ...
  longName.set("Spring Test Framework for VMware GemFire 9.15 and Spring Data 2.7")
  description.set("Spring Test Framework for VMware GemFire 9.15 and Spring Data 2.7")
}
