...
publishingDetails {
  artifactName.set("spring-test-gemfire-${getGemFireBaseVersion()}-3.0")
  longName.set("Spring Test Framework for VMware GemFire 10.0 and Spring Data 3.0")
  description.set("Spring Test Framework for VMware GemFire 10.0 and Spring Data 3.0")
}
