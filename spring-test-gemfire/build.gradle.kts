...
publishingDetails {
  ...
  longName.set("Spring Test Framework for VMware GemFire 10.1 and Spring Data 3.3")
  description.set("Spring Test Framework for VMware GemFire 10.1 and Spring Data 3.3")
}
