...
publishingDetails {
  ...
  longName.set("Spring Test Framework for VMware GemFire 10.0 and Spring Data 2.7")
  description.set("Spring Test Framework for VMware GemFire 10.0 and Spring Data 2.7")
}
