...
publishingDetails {
  artifactName.set("spring-test-gemfire-${getGemFireBaseVersion()}-2.6")
  longName.set("Spring Test Framework for VMware GemFire 9.15 and Spring Data 2.6")
  description.set("Spring Test Framework for VMware GemFire 9.15 and Spring Data 2.6")
}
