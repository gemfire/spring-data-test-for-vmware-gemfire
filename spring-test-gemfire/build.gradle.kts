...
publishingDetails {
  ...
  longName.set("Spring Test Framework for VMware GemFire 9.15 and Spring Data 3.0")
  description.set("Spring Test Framework for VMware GemFire 9.15 and Spring Data 3.0")
}
