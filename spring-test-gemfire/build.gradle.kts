...
publishingDetails {
  artifactName.set("spring-test-gemfire-${getGemFireBaseVersion()}-3.1")
  longName.set("Spring Test Framework for VMware GemFire 10.1 and Spring Data 3.1")
  description.set("Spring Test Framework for VMware GemFire 10.1 and Spring Data 3.1")
}
