    ...
    create<MavenPublication>("maven") {
      afterEvaluate {
        ...
        pom {
          ...
          scm {
            connection = "scm:git:https://github.com/gemfire/spring-data-test-for-vmware-gemfire.git"
            developerConnection =
              "scm:git:https://github.com/gemfire/spring-data-test-for-vmware-gemfire.git"
            url = "https://github.com/gemfire/spring-data-test-for-vmware-gemfire"
          }
        }
      }
      repositories {
